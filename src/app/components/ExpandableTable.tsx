...
const ExpandableTable = ({advocates}: {advocates: Advocate[]}): JSX.Element => {
        ...
        <table className={classNames("table", "table-accordion")}>
          ...
          <tbody>
            {advocates.map((advocate) => {
              ...
              const displayedSpecialties = isExpanded || !isExpandable
              ...
              return (
                <>
                  ...
                  >
                    ...
                    <td className={classNames("expandable-cell", "relative", "specialtiesColumn")}>
